  ...
  `;
    ...
    function aqGetDataRef$1() {
      ...
      _aqDataRef = (async function () {
        ...
        try {
          const r = await fetch('https://api.github.com/repos/' + REPO$1 + '/commits/main', { headers: { 'Accept': 'application/vnd.github.sha' } });
    ...
    async function aqDataUrl(file) { return 'https://cdn.jsdelivr.net/gh/' + REPO$1 + '@' + (await aqGetDataRef$1()) + '/' + file; }
    const PER_PAGE  = 12;
